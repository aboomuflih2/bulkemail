...
import { FileUploadResponse, SendEmailRequest, SendEmailResponse } from '../types/email.js';
...
router.post('/send-emails', async (req, res) => {
  try {
    const { subject, message, cc, provider, recipients, smtpConfig }: SendEmailRequest = req.body;
